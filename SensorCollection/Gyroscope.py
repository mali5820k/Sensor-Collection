...
def getGyroAccelMagno():
    ...
    return {"gyroscope": [gyroXangle, gyroYangle, gyroZangle], "accelerometer": [ACCx, ACCy, ACCz], "KalmanFiltered": [kalmanX, kalmanY], "Compass" : [MAGx, MAGy, MAGz], "Rotation" : [AccXangle, AccYangle]}
